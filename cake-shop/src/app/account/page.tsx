  ...
  return (
    <DashboardShell title="Welcome back, Amaya" subtitle="Customer dashboard" nav={nav} activeHref="/account">
      <div className="grid gap-5 sm:grid-cols-3">
        ...
        <div className="rounded-2xl border border-line bg-white/70 p-5 opacity-60">
      ...
      <div className="mt-8 flex items-center gap-3 rounded-2xl border border-dashed border-line bg-cream-dim/60 p-5 text-sm text-espresso-soft">
