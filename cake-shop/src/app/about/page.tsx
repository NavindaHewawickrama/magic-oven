...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-4xl px-5 py-16">
      ...
      <h1 className="mt-1 font-display text-4xl font-semibold">About Sweet Layers</h1>
      ...
      <div className="mt-14">
        <h2 className="font-display text-2xl font-semibold">Our journey</h2>
        <div className="mt-6 space-y-6 border-l-2 border-line pl-6">
          {milestones.map((m) => (
            <div key={m.year} className="relative">
              ...
              <p className="mt-1 text-espresso-soft">{m.text}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="mt-14 grid gap-6 sm:grid-cols-3">
        {[
          ...
          <div key={s.label} className="rounded-2xl border border-line bg-white/70 p-6 text-center">
