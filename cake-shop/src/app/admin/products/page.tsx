  ...
  return (
    <DashboardShell title="Products" subtitle="Admin CMS" nav={adminNav} activeHref="/admin/products">
      <div className="mb-5 flex items-center justify-between">
        ...
        <button onClick={openNew} className="inline-flex items-center gap-2 rounded-full bg-brick px-4 py-2 text-sm font-semibold text-cream">
            ...
            >
              <div className="grid grid-cols-2 gap-3">
                <div className="col-span-2">
                  ...
                  <input defaultValue={editing?.name} required className="mt-1 w-full rounded-xl border border-line bg-white px-3 py-2 text-sm outline-none focus:border-brick" />
                </div>
                <div>
                  <label className="text-xs font-semibold uppercase text-espresso-soft">Price (Rs.)</label>
                  <input type="number" defaultValue={editing?.price} className="mt-1 w-full rounded-xl border border-line bg-white px-3 py-2 text-sm outline-none focus:border-brick" />
                </div>
                <div>
                  <label className="text-xs font-semibold uppercase text-espresso-soft">Category</label>
                  <select defaultValue={editing?.category} className="mt-1 w-full rounded-xl border border-line bg-white px-3 py-2 text-sm outline-none focus:border-brick">
                ...
                <div className="col-span-2">
                  ...
                  <textarea defaultValue={editing?.description} rows={3} className="mt-1 w-full resize-none rounded-xl border border-line bg-white px-3 py-2 text-sm outline-none focus:border-brick" />
                </div>
                <div className="col-span-2">
              ...
              <button type="submit" className="w-full rounded-full bg-brick py-2.5 text-sm font-semibold text-cream">
