    ...
    <AuthCard title="Reset your password" subtitle="We'll send a reset link to your email.">
      <form className="space-y-4">
        <div>
          ...
          <input type="email" required placeholder="you@example.com" className="mt-1.5 w-full rounded-lg border border-line bg-cream-dim px-4 py-2.5 text-sm outline-none focus:border-brick" />
        </div>
