    ...
    <AuthCard title="Create your account" subtitle="Just the essentials — name, contact and a password.">
      <form className="space-y-4">
        <div>
          ...
          <input required placeholder="Amaya Perera" className="mt-1.5 w-full rounded-xl border border-line bg-cream px-4 py-2.5 text-sm outline-none focus:border-brick" />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="tel" placeholder="+94 7X XXX XXXX" className="mt-1.5 w-full rounded-xl border border-line bg-cream px-4 py-2.5 text-sm outline-none focus:border-brick" />
        </div>
        <div>
